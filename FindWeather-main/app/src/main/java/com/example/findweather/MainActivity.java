...
public class MainActivity extends AppCompatActivity {
    ...
    TextView tempText;
    TextView minTempText,minTemp,maxTemp,pressure,humidity,wind_speed;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wind_speedText = findViewById(R.id.windspeed_tv);
        ...
        wind_speed = findViewById(R.id.speed_tv);
    ...
    public class DownloadWeather extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                JSONObject windData = new JSONObject(windInfo);
               ...
               wind_speedText.setVisibility(View.VISIBLE);
